...
<div id="banner" class="banner1 full-screen-mode parallax" style="height: 155px;">
            <div class="container pr">
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <div class="banner-static">
                        <div class="banner-text">
                    ...
                    <div class="blog-box clearfix">
                        ...
                        <div class="wow fadeIn" data-wow-duration="1s" data-wow-delay="0.1s">
                            <div class="col-md-6 col-sm-6">
                                <div class="blog-block">
                                    <div class="blog-img-box">
                                        <img src="images/reviews.jpg" alt="" style="height: 220px;"/>
                                        <div class="overlay">
                                            <a href=""><i class="fa fa-link" aria-hidden="true"></i></a>
                                        </div>
                                    </div>
...
<!--                        <div class="wow fadeIn" data-wow-duration="1s" data-wow-delay="0.1s">
                            ...
                            <div class="col-md-6 col-sm-6">
                                <div class="blog-block">
                                    ...
                                    <div class="blog-dit">
                                          ...
                                          <a href="https://www.gamezop.com/g/SkhljT2fdgb/Ludo-With-Friends#Boot"><h2>Games</h2></a>
                                        <h5>BY Jeffrey Spender</h5>
                                    </div>
                                </div>
                            </div>
             ...
             <%  String pno = null;     
                    try {
                        PreparedStatement pstn1 = con.prepareStatement("select * from orderdetail where mobile=? limit 1");
